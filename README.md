...
#### IMPORTANT NOTE
This project has been moved to [dedicated github account](https://github.com/easylogging/) as of v9.0 and will be developed on this new account. This repository will not be updated anymore.
