...
public:
    ...
    static inline const std::string version(void) { return std::string("7.37"); }

    // Release date of current version
    static inline const std::string releaseDate(void) { return std::string("24-03-2013 2107hrs"); }
