...
public:
    ...
    static inline const std::string version(void) { return std::string("9.31"); }
    /// @brief Release date of current version
    static inline const std::string releaseDate(void) { return std::string("20-10-2013 1316hrs"); }
};
} // namespace el
#undef VLOG_IS_ON
