...
public:
    ...
    static inline const std::string version(void) { return std::string("9.56"); }
    /// @brief Release date of current version
    static inline const std::string releaseDate(void) { return std::string("24-02-2014 1815hrs"); }
};
}  // namespace el
#undef VLOG_IS_ON
