...
public:
    ...
    static inline const std::string version(void) { return std::string("9.23"); }
    /// @brief Release date of current version
    static inline const std::string releaseDate(void) { return std::string("04-10-2013 1932hrs"); }
};
} // namespace el
#undef VLOG_IS_ON
