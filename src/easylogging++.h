...
public:
    ...
    static inline const std::string version(void) { return std::string("9.62"); }
    /// @brief Release date of current version
    static inline const std::string releaseDate(void) { return std::string("29-03-2014 0033hrs"); }
};
}  // namespace el
#undef VLOG_IS_ON
