...
public:
    ...
    static inline const std::string version(void) { return std::string("9.34"); }
    /// @brief Release date of current version
    static inline const std::string releaseDate(void) { return std::string("23-10-2013 1844hrs"); }
};
} // namespace el
#undef VLOG_IS_ON
